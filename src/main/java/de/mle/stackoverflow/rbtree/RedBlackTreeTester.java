...
public class RedBlackTreeTester {
	/**
	 * Tests if the given tree is a red black tree with respect to the following
	 * conditions:
	 * 
	 * <pre>
	...
	/**
	 * Returns the height of the given red black tree. Black null-leafs do not
	 * count for the height.
	 *
	 * @param tree
	 *            The red black tree under test.
	...
	/**
	 * Returns the black-depth of the given red black tree. Black null-leafs do
	 * not count for the black-depth.
	 *
	 * @param tree
	 *            The red black tree under test.
	 * @return the height of the given red black tree.
